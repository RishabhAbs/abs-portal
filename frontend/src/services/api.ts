...
export const itemsApi = {
  ...
  createCategory: (name: string, parent_id?: number | null) => fetchApi<{ success: boolean; data: any }>('/items/categories', { method: 'POST', body: JSON.stringify({ name, parent_id }) }),
  updateCategory: (id: number, name: string, parent_id?: number | null) => fetchApi<{ success: boolean }>(`/items/categories/${id}`, { method: 'PUT', body: JSON.stringify({ name, parent_id }) }),
